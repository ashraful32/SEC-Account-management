...
<div class = "con1">
	...
	<h1> <center>Welcome SEC Account Management Office Staff Page </center></h1>
	 ...
	 <form method = "post" action = "dept_show.php">
		<h1> Search Form</h1>
...
if(isset($_POST['submit'])){
	...
	if(mysql_num_rows($run)> 0){
	  ...
	  echo "<script>window.open('sea11.php','_self')</script>";
	}
	else{
	...
	if(mysql_num_rows($run)> 0){
	  ...
	  echo "<script>window.open('sea13.php','_self')</script>";
	}
	else{
	...
	if(mysql_num_rows($run)> 0){
	  ...
	  echo "<script>window.open('sea14.php','_self')</script>";
	}
	else{
	...
	if(mysql_num_rows($run)> 0){
	  ...
	  echo "<script>window.open('sea15.php','_self')</script>";
	}
	else{
		echo "<script>alert('This  student not given payment fee.')</script>";
	}
