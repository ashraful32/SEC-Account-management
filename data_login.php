...
<div class = "con1">
	...
	<h1> <center>SEC Account Management Office Staff Page </center></h1>
...
if(isset($_POST['submit'])){
	...
	$check_user = "select * from admin where Data_user = '$user_name' and Data_pass = '$user_pass'";
	...
	if(mysqli_num_rows($run)> 0){
		...
		echo "<script>window.open('data_go.php','_self')</script>";
	}
	else{
